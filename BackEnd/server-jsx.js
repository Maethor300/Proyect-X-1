...
app.use(cors());
app.post('/agregarDatos', function (req, res) {
  var _req$body = req.body,
    id = _req$body.id,
    nombre = _req$body.nombre,
    email = _req$body.email,
    telefono = _req$body.telefono,
    opcion = _req$body.opcion;
  Formulario.create({
    id: id,
    nombre: nombre,
    email: email,
...
app.get('/consulta', /*#__PURE__*/function () {
...
app.get('/miPagina', function (req, res) {
